...
public enum DataType {
  ...
  /**
   * A fixed length binary column longer than the 255 byte {@link #BINARY},
   * which the engine calls "BigBinary".  Only the {@code Data} column of
   ...
   * BINARY/OLE.
   */
  BIG_BINARY((byte) 0x11, null, 3992),
  /**
